...
TEST_CASE("SplitString", "[simple]") {
  ...
  CHECK(SplitString("Штирлиц играл в карты в компании и проигрался. Но он умел делать хорошую мину при плохой игре. Когда Штирлиц покинул компанию, мину взорвалась.") == std::vector<std::string>{"Штирлиц", "играл", "в", "карты", "в", "компании", "и", "проигрался.", "Но", "он", "умел", "делать", "хорошую", "мину", "при", "плохой", "игре.", "Когда", "Штирлиц", "покинул", "компанию,", "мину", "взорвалась."});
